/*
Escreva um programa em C# Sharp para imprimir ou exibir o triangular inferior de uma determinada matriz.
Dados de teste :
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("\nDefinindo zero na matriz triangular inferior:\n");
        ImprimirTriangularInferior(matriz);
    }
    ...
    static void ImprimirTriangularInferior(int[,] matriz)
    {
